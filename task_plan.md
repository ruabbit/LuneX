...
| 18. tvOS/visionOS 运行适配 | in_progress | OpenSpec `integrate-tvos-visionos-runtime`为`25/50 ready`；1.1–4.6已完成task级验收，下一项5.1 visionOS windowed surface observation |
