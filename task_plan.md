...
- 阶段14 `integrate-macos-native-input-lifecycle` 当前权威进度`28/29`；确定性实现/验证/跟踪已完成并计划执行阶段级离线自验，唯一剩余6.5为授权Sunshine/物理输入/多显示器，不得archive。下一可执行项为阶段15 OpenSpec提案。
