...
| 16. 空间音频运行接线 | in_progress | OpenSpec `integrate-spatial-audio-runtime`进度`13/35`；graph、平台策略、测试矩阵、embedded reader及macOS/iOS/tvOS entitlement build配置已完成，下一项移动/TV/vision audio-session adapter |
