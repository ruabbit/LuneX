...
| 16. 空间音频运行接线 | in_progress | OpenSpec `integrate-spatial-audio-runtime`进度`15/35`；graph、平台策略、entitlement、移动audio-session及macOS actual-output capability已完成，下一项route/interruption/capability monitor |
