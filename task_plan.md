...
| 17. iOS/iPadOS scene、PiP 与连续性 | in_progress | OpenSpec `integrate-mobile-scene-pip-continuity`进度`21/36`；4.5已完成generation-scoped lifecycle orchestration，当前推进4.6 single-decoder decoded-frame/PiP presentation integration |
...
阶段17 OpenSpec `integrate-mobile-scene-pip-continuity`已进入`in_progress`，权威进度`21/36`。1.x值合同和确定性矩阵、2.1至2.6 actual UIKit scene/window/geometry/drawable/video/input ownership、3.1至3.5 actual-window mobile EDR观察与renderer接线均已完成。4.1至4.4完成generation-scoped client、同pixel-buffer sample adapter、单槽display-layer sink与production AVKit adapter；4.5新增main-actor lifecycle coordinator，序列化prepare/start/confirmed-active/stop/failure/capability/frame-sink/restore/playback/skip/invalidation/replacement，并在terminal路径先关闭重入再直接drain native callback lease。4.5验收为focused `13/13`、expanded `67/67`、完整macOS `852 total / 851 passed / 1 explicit Keychain skip`、四平台generic Debug与8/8 strict/generator/repository门通过。下一项4.6订阅既有decoded-frame presentation source，以同一decoder output服务foreground Metal与PiP并协调foreground pause/throttle/resume；6.6物理iPhone/iPad、系统PiP、Stage Manager、external display、visible EDR、power与live Sunshine证据保持独立pending。
...
- 阶段17 `integrate-mobile-scene-pip-continuity`权威进度`21/36 in_progress`；2.1至2.6完成actual mobile surface lifecycle/geometry/drawable/video/input绑定，3.1至3.5完成actual-window mobile EDR读取与renderer接线，4.1至4.5完成injectable PiP client、不复制的sample adapter、真实display-layer backpressure sink、production AVKit adapter和generation-scoped lifecycle reducer orchestration。下一项4.6把既有decoded-frame presentation source接入PiP并协调foreground Metal pause/throttle/resume，不创建第二decoder；当前generic build和离线测试仍不证明live Stage Manager、系统PiP、background、visible mobile EDR、signed/physical设备或live Sunshine。
