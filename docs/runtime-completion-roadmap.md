...
| 18 | `in_progress`，OpenSpec `4/50` | 1.1 baseline、1.2 shared snapshot、1.3 tvOS focus/capture，以及1.4 visionOS windowed/exact immersive-unavailable/capability admission/system-reserved/focus-teardown release纯值合同完成；1.4 focused `15/15`、normal `953/952/1/0`、五平台Debug和repository门通过 | 下一项1.5 finite/stale/privacy/capability扩展测试；仍无actual handler、generation-owned platform owner、输入/scene/media接线或物理设备证据 |
...
- OpenSpec `integrate-tvos-visionos-runtime`当前`4/50 ready`，下一项1.5。1.4固定visionOS windowed mode，完整表达immersive/stereoscopic/volumetric/passthrough unavailable，按current generation/scene/focus/capability admission五类input，并区分focus-loss与teardown ordered release/idempotency。1.2至1.4都不持有框架对象或连接actual platform runtime。
