...
| 18 | `in_progress`，OpenSpec `44/50 ready` | 1.1–8.2已完成task级离线验收；8.2 fresh十项五平台Debug/Release isolated unsigned warnings-as-errors build均`succeeded/0 warning/0 error/0 analyzer warning/1 AIR/1 metallib`且repository pre-gate通过 | next 8.3；8.3-8.8、Simulator runtime、signed/物理/live HDR/audio/input及性能功耗证据未完成 |
