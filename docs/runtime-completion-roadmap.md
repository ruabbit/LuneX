...
| 18 | `in_progress`，OpenSpec `31/50 ready` | 1.1–5.6已勾选；5.6三条multiwindow/resize/focus/capability/reserved/mapping/release/stale/replacement/teardown连接矩阵及fresh focused/related/normal/五平台build、repository/final-state门均通过 | next 6.1；6.x–8.x、visionOS媒体、产品、release及Simulator runtime/signed/物理/live HDR/audio证据未完成 |
