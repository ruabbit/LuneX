...
| 19 | `in_progress`，OpenSpec `complete-native-product-workflows` | host/pairing/catalog/session恢复、多窗口ownership、typed semantics、adaptive layout、keyboard/Voice Control、iOS touch/text/non-color state及Reduce Motion合同已有确定性实现与任务级离线验收 | 5.5以后tvOS/visionOS focus、完整accessibility matrix、diagnostics export、跨产品回归及signed/physical/live验收仍未完成 |
...
- Task 5.3不证明物理hardware keyboard焦点、VoiceOver/Voice Control识别、iPad Stage Manager、signed安装或live Sunshine input；5.4现提供离线touch/reduced-motion合同，5.5 tvOS/visionOS focus、5.6综合矩阵和7.7物理验收继续pending。
