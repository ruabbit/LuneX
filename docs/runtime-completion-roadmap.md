...
| 18 | `in_progress`，OpenSpec `28/50` | 1.1–5.3已勾选；tvOS媒体运行时、actual visionOS window observation、shared geometry/render/input mapping及public controller/keyboard/indirect-pointer adapter与current-generation admission均已完成离线和unsigned build验收 | 5.4–8.x、完整reserved/release策略、visionOS媒体、产品、release及signed/物理/live HDR/audio证据未完成 |
