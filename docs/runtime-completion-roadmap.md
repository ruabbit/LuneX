...
| 18 | `in_progress`，OpenSpec `25/50` | 1.1–4.6已勾选；consolidated tvOS media matrix通过fresh `249/249` focused、`474/474` related、`1056/1055/1/0` normal、direct tvOS及unsigned五平台Debug | 5.1–8.x、visionOS、产品、release及signed/物理/live HDR/audio证据未完成 |
