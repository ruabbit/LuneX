...
| 18 | `in_progress`，OpenSpec `24/50` | 1.1–4.5已勾选；same-view current geometry/display replay与shared terminal/resource teardown已接入，fresh `248/248` focused、`474/474` related、`1055/1054/1/0` normal、direct tvOS及unsigned五平台Debug均通过 | 4.6–8.x、visionOS、产品、release及signed/物理/live HDR/audio证据未完成 |
