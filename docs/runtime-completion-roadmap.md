...
| 18 | `in_progress`，OpenSpec pre-mark `34/50 ready` | 1.1–6.3已完成；6.4已在repository gate前接入共享canonical audio event/graph、visionOS public intended spatial experience、actual route capability、interruption/media reset、graph/presentation replacement与current-generation清理 | gate通过后推进到35/50 next 6.5；6.5–8.x、actual-state UI、Simulator runtime、signed/物理/live HDR/audio证据未完成 |
