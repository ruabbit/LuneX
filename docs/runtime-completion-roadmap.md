...
| 18 | `in_progress`，OpenSpec `21/50` | 1.1–4.2已勾选；4.2实现tvOS 26.4 public preferred-dynamic-range/tone-map/content-headroom与actual-screen capability resolver、typed HDR-to-SDR fallback、headroom-tagged surface contract及完整transaction rollback；fresh `54/54` focused、`209/209` related、`1040/1039/1/0` normal、direct tvOS、unsigned五平台Debug及repository pre-gate均通过 | 4.3–8.x actual display revision/AppModel、audio、visionOS、产品、release及signed/物理/live HDR证据未完成 |
