...
- OpenSpec `integrate-mobile-scene-pip-continuity`当前`33/36 in_progress`；1.x至5.6及6.1–6.4均已完成。完整normal与完整ASan/TSan均为`909/908/1/0`且唯一skip是显式真实Keychain用例；6.2十配置build与6.3 repository/API/analyzer门通过。6.4的ASan `/tmp/LuneX-17-6_4-asan.wtKUhx`、TSan `/tmp/LuneX-17-6_4-tsan.7v8bx9`均零sanitizer report，16-suite malloc/resource `/tmp/LuneX-17-6_4-resource.6jwPh7`为`320/320`且零allocator report，覆盖frame/backpressure release、observer cancellation、replacement、restore completion与clean stop。下一项6.5为fixed simulator bounded checks；这些macOS确定性证据仍不证明签名接受、system PiP、background duration、Stage Manager、visible EDR或live Sunshine。
