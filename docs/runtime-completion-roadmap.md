...
| 18 | `in_progress`，OpenSpec `29/50` | 1.1–5.4已勾选；reserved hardware key只发布current-surface typed local state且零Moonlight event，无源的recenter/safety/gaze/hand留给系统；fresh离线、unsigned及repository/final-state门通过 | 5.5–8.x、held release/local restoration、visionOS媒体、产品、release及signed/物理/live HDR/audio证据未完成 |
