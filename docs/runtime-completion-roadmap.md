...
| 18 | `in_progress`，OpenSpec `43/50 ready` | 1.1–8.1已完成task级离线验收；8.1 fresh complete normal为`1123/1122/1 exact Keychain skip/0`、零结构化build diagnostics与`1 AIR/1 metallib`，两个真实opt-in显式移除并使用文件fallback，repository pre-gate已通过 | next 8.2；五平台Debug/Release、8.3-8.8、Simulator runtime、signed/物理/live HDR/audio/input及性能功耗证据未完成 |
