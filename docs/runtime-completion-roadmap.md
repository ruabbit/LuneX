...
- OpenSpec `integrate-tvos-visionos-runtime`当前`10/50 ready`，1.1–2.4完成。2.4实现FIFO serialized coordinator、scene/input/display/audio统一semantic revision、display fail-closed、单一current video delivery、decoder/revision/ownership拒绝、bounded diagnostics、replacement及single shared teardown；修订后fresh focused `13/13`、normal `988/987/1 exact Keychain skip/0`、五平台Debug与final repository gate均通过。下一项2.5 media/AppModel application；actual adapters及signed/physical/live证据仍未实现。
