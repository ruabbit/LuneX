...
| 14 | `in_progress`，OpenSpec `26/29` | 完成AppKit合同、共享坐标、闭合directive、generation-scoped lifecycle、AppModel/media application、active input coordinator、actual direct/relative capture、balanced cursor ownership、responder/dismantle、stream-view backing/display/live-resize检测、privacy-bounded diagnostics、application/normal/五平台Debug+Release门，以及strict/generator/analyzer/ASan/TSan/malloc资源门 | simulator独立最终门与live hardware证明尚未完成 |
