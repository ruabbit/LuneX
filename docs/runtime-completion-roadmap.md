...
| 18 | `in_progress`，OpenSpec `23/50` | 1.1–4.4已勾选；actual tvOS screen/layer HDR与current audio route/canonical graph/spatial/head-tracking capability、interruption/media reset/recovery已接入current coordinator/AppModel；4.4 fresh `248/248` focused、`332/332` related、`1054/1053/1/0` normal、direct tvOS及unsigned五平台Debug均通过 | 4.5–8.x shared reconnect、visionOS、产品、release及signed/物理/live HDR/audio证据未完成；same-view geometry replay明确保留给4.5 |
