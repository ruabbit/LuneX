...
| 15 | `in_progress`，OpenSpec `30/33` | color/luminance、decoded/Metal frame、shader/readback、surface/display/resolver/presenter、macOS transition矩阵、四平台typed capability/fallback、5.1–5.5 integration、6.1–6.3 normal/build/quality-resource门完成 | 6.4–6.6模拟器/硬件/跟踪、live/compositor与物理显示器证据仍待完成 |
...
- OpenSpec `implement-native-hdr-edr-pipeline`当前`30/33`；6.3已通过OpenSpec strict `6/6`、fixture/generator/clean-room/dependency、四SDK Metal、Debug/Release analyzer、完整ASan/TSan与24类malloc/resource-release门。ASan和TSan各`615 passed + 1 Keychain skip`，资源集合`343/343`，最终xcresult结构化诊断为零；下一项6.4为固定simulator identity/state独立只读门。
