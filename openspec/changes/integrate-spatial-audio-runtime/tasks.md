...
- [ ] 1.2 Define immutable mono, stereo, WAVE 5.1, and WAVE 7.1 semantic channel-layout contracts with Core Audio tags, stable signatures, spatial eligibility, and closed unsupported-layout errors
