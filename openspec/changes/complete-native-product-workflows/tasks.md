...
- [x] 4.6 Add deterministic two-workspace application tests for isolated navigation/selection/presentation, shared data updates, stale generation rejection, non-owner commands, and close policy.
