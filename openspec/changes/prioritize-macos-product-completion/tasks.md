...
- [x] 2.2 Record the designated host's server-advertised protocol/capability inventory and live test matrix without a Sunshine package-version allowlist or unrelated host mutation.
