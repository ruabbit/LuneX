...
- [ ] 1.1 Inventory current decoded formats, metadata ownership, renderer behavior, Apple EDR APIs, platform capability differences, and hardware proof limits without changing runtime behavior
