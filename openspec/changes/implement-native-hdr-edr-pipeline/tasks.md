...
- [x] 1.6 Add deterministic invalid-combination, known-vector, monotonicity, continuity, gamut, missing-metadata, headroom, and numeric-bound tests
...
- [x] 4.6 Add compile-safe iOS/iPadOS, tvOS, and visionOS capability adapters with explicit unsupported/fallback results rather than AppKit assumptions
...
- [x] 6.6 Update planning and roadmap evidence, document platform/hardware limits, commit each completed task, and push
